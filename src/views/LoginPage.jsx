...
import { createUserWithEmailAndPassword, sendPasswordResetEmail, signInWithEmailAndPassword, onAuthStateChanged } from "firebase/auth";
...
function LoginPage() {
  ...
  onAuthStateChanged(auth, (user) => {
    if (user) {
      ...
      dispatch(setUser({id: user.uid, email: user.uid}));
      ...
      <div className="container login-page">
        <section>
          ...
          <form className="add-form login">
            ...
            <p onClick={(e) => { handlePassowrdReset(e) }} className="forgot-password">Forgot Password?</p>
